            ...
            <div class="col-12 col-md-12">
                ...
                <div id="about" class="tab-contents">
                    ...
                    <section>
                        ...
                        <p>
                            Lanre Shittu Motors has from inception performed excellently in the supply and maintenance of large volume of vehicles to the Government (State & Federal), Corporate Bodies, Financial and Academic Institutions and Individual occasional demands.
                        </p>
                    </section>
                    <br>
                    <section>
                        ...
                        <p>Lanre Shittu is known to offer the “right autos… right place”.</p>
                    </section>
                </div>
                <!-- Vision -->
                <div id="vision" class="tab-contents">
                    <h3>Our Vision</h3> <br>
                    <p>
                ...
                <div id="mission" class="tab-contents">
                 <h3>Our Mission</h3>
                 <p>
                    To provide affordable, dependable and guaranteed vehicles in a manner that exceeds our customers' expectations and to deliver the vehicles at fair prices.
                    We at Lanre Shittu Motors Nigeria Ltd have worked consistently for years to ensure we deliver our customers' satisfaction at every stage.
                 </p>
                ...
                <div id="team" class="tab-contents">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('assets/front_assets/images/team/alhaji_rasaq_olanrewaju_shittu.png') }}" alt="alhaji rasaq olanrewaju shittu" />
                        </div>
                        <div class="col-md-8">
                            <strong>Alhaji Rasaq Olanrewaju Shittu, MD/CEO</strong>
                            <p>
                                Alhaji Rasaq Olanrewaju is the founder and Chairman of the Lanre Shittu Group.
                                He is an astute business man with very many years of experience.
                                Alhaji Shittu is a force to be reckoned with in the automobile business world with great finesse and charisma.
                                A well-travelled man with business knowledge fully attuned, the Lanre Shittu Motors financial empire has grown to encompass a multi-faceted business conglomerate determined to break the myths and perceptions of African developmental limitations, thanks to his management expertise.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('assets/front_assets/images/team/richard.jpg') }}" alt="richard shittu director of operations" />
                        </div>
                        <div class="col-md-9">
                    ...
                    <!-- <div class="row">
                        ...
                        <div class="col-md-9">
                            <strong>Biodun Isiaka Shittu, Director - Administration</strong>
                            <p>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('assets/front_assets/images/team/taiwo_shittu.jpg') }}" alt="taiwo shittu group executive director" />
                        </div>
                        <div class="col-md-9">
                            <strong>Taiwo Shittu - Group Executive Director</strong>
                            <p>
                                Taiwo Shittu is a graduate of Business Administration from Babcock University, Ilisan – Remo, Ogun State. He is a Chartered Manager with Oracle Certification.
                            </p>
                            <p>
                                A nominee for the 10 best professionals by This Day Newspaper for the year 2010, Taiwo Shittu is a young and focused gentleman with a passion to drive the Nigerian Automobile Industry to its peak.
                            </p>
                        </div>
                    </div>
                </div>
